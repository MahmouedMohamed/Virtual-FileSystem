...
public class LinkedAllocator implements Allocator {
	...
	public void Allocate(String filepath, int Size) {
    	...
    	if(AllocatedSpace.size()>0)
    	{
            ...
            try {
				offset=parseFile("C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\SubDirectories.txt",folder);
    		...
    		PrintWriter writer;
            try {
    			writer = new PrintWriter("C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\SubDirectories.txt");
    			writer.print("");
    			writer.close();
    			writer = new PrintWriter("C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\Files.txt");
    			writer.print("");
    			writer.close();
    			writer = new PrintWriter("C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\Blocks.txt");
    			writer.print("");
    			writer.close();
    			writer = new PrintWriter("C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\Blocks2.txt");
    			writer.print("");
    			writer.close();
			...
			for(int i=0;i<directories.size();i++)                 //////////////////////writing to directory file .txt 
			{
				try {
					...
					FileWriter fileWriter = new FileWriter("C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\SubDirectories.txt", true);
			...
			for(int i=0;i<directories.size();i++)                        ////writing to files .txt           
			{
				...
				try {
							FileWriter fileWriter = new FileWriter("C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\Files.txt", true);
							PrintWriter printWriter = new PrintWriter(fileWriter);
							if(i+1<directories.size())
						    {
							    printWriter.println(KOLO);
			...
			for(int i=0;i<directories.size();i++)           ////////////////////writing index block for each file 
			{
				for(int j=0;j<directories.elementAt(i).getfilessize();j++)
				{
						KOLO+=directories.elementAt(i).getspecificfileindexblock(j)+" ";
						KOLO+=Integer.toString(directories.elementAt(i).getspecificfilelastindexblock(j));
						if(j+1<directories.elementAt(i).getfilessize())
						{
							KOLO+="  ";
						}
				...
				try {
					FileWriter fileWriter = new FileWriter("C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\Blocks.txt", true);
					PrintWriter printWriter = new PrintWriter(fileWriter);
			...
			for(int i=0;i<NumberOfBlocks;i++)            //////////////////writing blocks 
			{
				for(int j=0;j<directories.size();j++)
				{
					for(int k=0;k<directories.elementAt(j).getfilessize();k++)
					{
						if(directories.elementAt(j).numexist(k, i)!=-1)
						{
							KOLO+=i+" "+directories.elementAt(j).numexist(k,i);
							break;
						}
					}
				}
				...
				try {
					FileWriter fileWriter = new FileWriter("C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\Blocks2.txt", true);
					PrintWriter printWriter = new PrintWriter(fileWriter);
			    	printWriter.println(KOLO);
			    	printWriter.close();
				}catch(IOException e) {e.printStackTrace();}
	...
	public void createfolder(String arg1) throws IOException {
		String filename="C:\\Users\\hp\\eclipse-workspace\\Mahmoued\\FileSystem\\Linked Allocation\\SubDirectories.txt";
